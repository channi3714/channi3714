...
## 🦁 About Me
- 🎓 **서강대학교** 아트&테크놀로지 | 컴퓨터공학 복수전공 (2021.03 ~ )
- 📚 **CNU 웹 개발 학회** 백엔드 파트 (2025.09 ~ 2026.01)
- 🛡️ **SINE 보안학회 1기** 활동 중 (2026.03 ~ )
- 💻 **멋쟁이사자처럼 서강 14기** 백엔드 파트 (2026.03 ~ )
...
## 📈 My Activity
### 📂 Notion Archives
- 🚀 [**전체 프로젝트 포트폴리오**](https://app.notion.com/p/Portfolio-3e1b0830003380b3bc02d6d3320718a5)
...
## 🚀 Projects
* **점메추 - 오늘의 점심 메뉴는?:** Django 기반 웹 서비스 개발
* **Find Me - 나를 찾아줘:** 유니티 기반 AR 스토리 게임 개발 (2022 GIGDC 인디게임 개발 경진대회 **은상 수상**)
* **Fin.Trip - 로컬 여행 SNS:** 서비스 기획 및 UI/UX 디자인 (공군 창업경진대회 **장려상 수상**)
* **CNU 사이드 프로젝트:** Spring Boot를 활용한 블로그 개발
* **MCC Wellness:** 진료 기록·인바디를 AI로 분석해 맞춤 식단·운동 루틴을 생성하는 웰니스 플랫폼
* **안전고래:** 사진·위치 기반 위험 신고를 AI가 작성해 담당부서로 신고하는 자동화 서비스 (2026 서강대학교 생성형 AI 기반 아이디어 공모전 **장려상 수상**)
